...
export const saveSizeFinishedApi = (size, getError, loadTime) => {
  const timeout = loadTime ? loadTime : 1300;
...
export const getSizeFinishedApi = (getError, loadTime) => {
  const timeout = loadTime ? loadTime : 1300;
